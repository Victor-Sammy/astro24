...
const Description = () => {
    ...
    return (
        <section className='min-h-screen pt-24'>
            ...
            <div className='w-4/5 mx-auto my-10 bg-accent shadow-2xl p-8 rounded-3xl grid grid-cols-2 gap-10'>
                ...
                <div className='text-left mt-3'>
                    ...
                    <div className='mt-5'>
                        ...
                        <div className='flex items-center'>
                            <p className='mr-5'>Available Size:</p>
                        ...
                        <div className='flex items-center mt-12'>
                            <button className='btn btn-primary text-accent capitalize font-normal rounded-xl w-48'>
                                <BiPurchaseTagAlt className='mr-2 text-xl' />
                                Buy Now
                            </button>
                            <button className='btn btn-outline btn-secondary text-accent capitalize font-normal rounded-xl w-48 ml-5'>
