...
const RecentAll = () => {
  ...
  return (
    <section className='min-h-screen pt-[88px] md:px-3 lg:px-0'>
      ...
      <div className='card bg-secondary lg:mx-auto w-[1210px] rounded-md border border-opacity-30 border-primary drop-shadow-xl'>
        <div className='row flex flex-wrap bg-secondary mt-10 mb-10 rounded-md'>
